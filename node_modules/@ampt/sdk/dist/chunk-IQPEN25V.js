...
import {
  ...
  systemError,
  systemLog
} from "./chunk-R467GWIW.js";
import {
  v4_default
} from "./chunk-DVAUNSLU.js";
import {
  getStore
...
var require_dayjs_min = __commonJS({
  "../../node_modules/dayjs/dayjs.min.js"(exports, module2) {
    ...
    !function(t4, e6) {
      ...
      "use strict";
      var t4 = 1e3, e6 = 6e4, n6 = 36e5, r6 = "millisecond", i6 = "second", s6 = "minute", u4 = "hour", a6 = "day", o6 = "week", c6 = "month", f6 = "quarter", h6 = "year", d6 = "date", l6 = "Invalid Date", $ = /^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/, y2 = /\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g, M = { name: "en", weekdays: "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"), months: "January_February_March_April_May_June_July_August_September_October_November_December".split("_"), ordinal: function(t5) {
        ...
        if (e7.date() < n7.date())
          return -t5(n7, e7);
        var r7 = 12 * (n7.year() - e7.year()) + (n7.month() - e7.month()), i7 = e7.clone().add(r7, c6), s7 = n7 - i7 < 0, u5 = e7.clone().add(r7 + (s7 ? -1 : 1), c6);
        return +(-(r7 + (n7 - i7) / (s7 ? i7 - u5 : u5 - i7)) || 0);
      }, a: function(t5) {
        return t5 < 0 ? Math.ceil(t5) || 0 : Math.floor(t5);
      }, p: function(t5) {
        return { M: c6, y: h6, w: o6, d: a6, D: d6, h: u4, m: s6, s: i6, ms: r6, Q: f6 }[t5] || String(t5 || "").toLowerCase().replace(/s$/, "");
      }, u: function(t5) {
        return void 0 === t5;
      } }, g6 = "en", D2 = {};
      D2[g6] = M;
      var p6 = "$isDayjsObject", S = function(t5) {
        return t5 instanceof _ || !(!t5 || !t5[p6]);
      }, w3 = function t5(e7, n7, r7) {
        var i7;
        if (!e7)
          return g6;
        if ("string" == typeof e7) {
      ...
      b6.l = w3, b6.i = S, b6.w = function(t5, e7) {
        return O(t5, { locale: e7.$L, utc: e7.$u, x: e7.$x, $offset: e7.$offset });
      };
      var _ = function() {
        function M2(t5) {
          this.$L = w3(t5.locale, null, true), this.parse(t5), this.$x = this.$x || t5.x || {}, this[p6] = true;
        }
        var m7 = M2.prototype;
        return m7.parse = function(t5) {
          ...
          return O(t5) < this.startOf(e7);
        }, m7.isBefore = function(t5, e7) {
          return this.endOf(e7) < O(t5);
        }, m7.$g = function(t5, e7, n7) {
          return b6.u(t5) ? this[e7] : this.set(n7, t5);
        }, m7.unix = function() {
          return Math.floor(this.valueOf() / 1e3);
        }, m7.valueOf = function() {
          return this.$d.getTime();
        }, m7.startOf = function(t5, e7) {
          var n7 = this, r7 = !!b6.u(e7) || e7, f7 = b6.p(t5), l7 = function(t6, e8) {
            var i7 = b6.w(n7.$u ? Date.UTC(n7.$y, e8, t6) : new Date(n7.$y, e8, t6), n7);
            return r7 ? i7 : i7.endOf(a6);
          }, $2 = function(t6, e8) {
            return b6.w(n7.toDate()[t6].apply(n7.toDate("s"), (r7 ? [0, 0, 0, 0] : [23, 59, 59, 999]).slice(e8)), n7);
          ...
          var n7, o7 = b6.p(t5), f7 = "set" + (this.$u ? "UTC" : ""), l7 = (n7 = {}, n7[a6] = f7 + "Date", n7[d6] = f7 + "Date", n7[c6] = f7 + "Month", n7[h6] = f7 + "FullYear", n7[u4] = f7 + "Hours", n7[s6] = f7 + "Minutes", n7[i6] = f7 + "Seconds", n7[r6] = f7 + "Milliseconds", n7)[o7], $2 = o7 === a6 ? this.$D + (e7 - this.$W) : e7;
          if (o7 === c6 || o7 === h6) {
          ...
          return this[b6.p(t5)]();
        }, m7.add = function(r7, f7) {
          var d7, l7 = this;
          r7 = Number(r7);
          var $2 = b6.p(f7), y3 = function(t5) {
            var e7 = O(l7);
            return b6.w(e7.date(e7.date() + Math.round(t5 * r7)), l7);
          };
          if ($2 === c6)
            return this.set(c6, this.$M + r7);
          if ($2 === h6)
            return this.set(h6, this.$y + r7);
          if ($2 === a6)
            return y3(1);
          if ($2 === o6)
            return y3(7);
          ...
          var r7 = t5 || "YYYY-MM-DDTHH:mm:ssZ", i7 = b6.z(this), s7 = this.$H, u5 = this.$m, a7 = this.$M, o7 = n7.weekdays, c7 = n7.months, f7 = n7.meridiem, h7 = function(t6, n8, i8, s8) {
            return t6 && (t6[n8] || t6(e7, r7)) || i8[n8].slice(0, s8);
          }, d7 = function(t6) {
            return b6.s(s7 % 12 || 12, t6, "0");
          }, $2 = f7 || function(t6, e8, n8) {
            var r8 = t6 < 12 ? "AM" : "PM";
          ...
          return r7.replace(y2, function(t6, r8) {
            return r8 || function(t7) {
              switch (t7) {
                ...
                case "YYYY":
                  return b6.s(e7.$y, 4, "0");
                case "M":
                  return a7 + 1;
                case "MM":
                  return b6.s(a7 + 1, 2, "0");
                case "MMM":
                  return h7(n7.monthsShort, a7, c7, 3);
                case "MMMM":
                  return h7(c7, a7);
                case "D":
                  return e7.$D;
                case "DD":
                  return b6.s(e7.$D, 2, "0");
                case "d":
                  return String(e7.$W);
                case "dd":
                  return h7(n7.weekdaysMin, e7.$W, o7, 2);
                case "ddd":
                  return h7(n7.weekdaysShort, e7.$W, o7, 3);
                case "dddd":
                  return o7[e7.$W];
                case "H":
                  return String(s7);
                ...
                case "s":
                  return String(e7.$s);
                case "ss":
                  return b6.s(e7.$s, 2, "0");
                case "SSS":
                  return b6.s(e7.$ms, 3, "0");
                case "Z":
                  return i7;
              }
              return null;
          ...
          var $2, y3 = this, M3 = b6.p(d7), m8 = O(r7), v5 = (m8.utcOffset() - this.utcOffset()) * e6, g7 = this - m8, D3 = function() {
            return b6.m(y3, m8);
          };
          switch (M3) {
            case h6:
          ...
          if (!t5)
            return this.$L;
          var n7 = this.clone(), r7 = w3(t5, e7, true);
      ...
      return O.prototype = k6, [["$ms", r6], ["$s", i6], ["$m", s6], ["$H", u4], ["$W", a6], ["$M", c6], ["$y", h6], ["$D", d6]].forEach(function(t5) {
        k6[t5[1]] = function(e7) {
          return this.$g(e7, t5[0], t5[1]);
        };
      }), O.extend = function(t5, e7) {
        return t5.$i || (t5(e7, _, O), t5.$i = true), O;
      }, O.locale = w3, O.isDayjs = S, O.unix = function(t5) {
        return O(1e3 * t5);
      }, O.en = D2[g6], O.Ls = D2, O.p = {}, O;
    });
  }
});
...
var STSServiceException = class _STSServiceException extends ServiceException2 {
  constructor(options) {
    super(options);
...
var AssumeRoleCommand = class _AssumeRoleCommand extends Command2 {
  static getEndpointParameterInstructions() {
    return {
...
var AssumeRoleWithWebIdentityCommand = class _AssumeRoleWithWebIdentityCommand extends Command2 {
  static getEndpointParameterInstructions() {
    return {
      UseGlobalEndpoint: { type: "builtInParams", name: "useGlobalEndpoint" },
      UseFIPS: { type: "builtInParams", name: "useFipsEndpoint" },
...
var SSOServiceException = class _SSOServiceException extends ServiceException2 {
  constructor(options) {
    super(options);
...
var GetRoleCredentialsCommand = class _GetRoleCredentialsCommand extends Command2 {
  static getEndpointParameterInstructions() {
    return {
      UseFIPS: { type: "builtInParams", name: "useFipsEndpoint" },
      Endpoint: { type: "builtInParams", name: "endpoint" },
...
var SSOOIDCServiceException = class _SSOOIDCServiceException extends ServiceException2 {
  constructor(options) {
    super(options);
...
var CreateTokenCommand = class _CreateTokenCommand extends Command2 {
  static getEndpointParameterInstructions() {
    return {
      UseFIPS: { type: "builtInParams", name: "useFipsEndpoint" },
      Endpoint: { type: "builtInParams", name: "endpoint" },
...
var STSClient = class _STSClient extends Client2 {
  constructor(configuration) {
...
var params_default = { get, getBatch, set: set2, setBatch, remove, removeBatch, scan };
...
var set3 = async (client, table, keys, value, opts) => {
  if (Array.isArray(keys)) {
...
var EventMethods = /* @__PURE__ */ ((EventMethods2) => {
  EventMethods2["PublishEvent"] = "Event:PublishEvent";
  return EventMethods2;
})(EventMethods || {});
var sqs = new SQS({});
...
async function handleEventItemChange(eventName, previous, item) {
  const { id, name, body: json, time, delay, ready } = item.value;
  if (eventName === "MODIFY" && ready && !previous?.value.ready) {
    const body = json ? tryParseJson(json) : void 0;
    if (json && !body) {
      systemLog({ item }, "Invalid JSON in event body");
      return;
    }
    const newDelay = Math.max(time + delay - Date.now(), 0);
    const message = {
      ...
      QueueUrl: process.env.EVENTS_QUEUE_URL,
      DelaySeconds: Math.ceil(newDelay / 1e3)
    };
    try {
      await sqs.sendMessage(message);
    } catch (err) {
      systemError(err, "Failed to send event to SQS");
      throw err;
    }
  }
}
