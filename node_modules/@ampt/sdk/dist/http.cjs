...
function createRequest(request2, context) {
  ...
  const body = request2.body instanceof import_node_stream3.Readable ? request2.body : request2.body instanceof import_web3.ReadableStream ? import_node_stream3.Readable.fromWeb(request2.body) : null;
