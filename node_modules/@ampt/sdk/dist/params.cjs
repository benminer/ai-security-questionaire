...
var require_isPlaceholder = __commonJS({
  "../../node_modules/ramda/src/internal/_isPlaceholder.js"(exports, module2) {
    "use strict";
    function _isPlaceholder(a5) {
      return a5 != null && typeof a5 === "object" && a5["@@functional/placeholder"] === true;
    }
...
var require_curry2 = __commonJS({
  "../../node_modules/ramda/src/internal/_curry2.js"(exports, module2) {
    ...
    var _isPlaceholder = require_isPlaceholder();
    function _curry2(fn) {
      return function f22(a5, b5) {
        switch (arguments.length) {
          case 0:
            return f22;
          case 1:
            return _isPlaceholder(a5) ? f22 : _curry1(function(_b) {
              return fn(a5, _b);
            });
          default:
            return _isPlaceholder(a5) && _isPlaceholder(b5) ? f22 : _isPlaceholder(a5) ? _curry1(function(_a) {
              return fn(_a, b5);
            }) : _isPlaceholder(b5) ? _curry1(function(_b) {
              return fn(a5, _b);
            }) : fn(a5, b5);
        }
      };
...
var require_execute = __commonJS({
  "../../node_modules/dread/execute.js"(exports, module2) {
    ...
    module2.exports = async function execute(task, { attempts, backoff, condition, timeout }) {
...
var require_condition = __commonJS({
  "../../node_modules/dread/condition.js"(exports, module2) {
    ...
    function is(t2) {
      return (err) => err instanceof t2;
    }
    function code(v2) {
      return (err) => err.code === v2;
    }
    function always() {
      return () => true;
    }
...
var require_dread = __commonJS({
  "../../node_modules/dread/dread.js"(exports, module2) {
    ...
    module2.exports = function dread2() {
      ...
      return typeof task === "function" ? execute(task, config) : dread2.bind(null, config);
    };
